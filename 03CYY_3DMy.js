...
window.onload=function main(){
	...
	var vertices=[
		...
		vec3(0.0,0.6,-0.333333),           //底面上方
		vec3(-0.4,-0.4,-0.333333),	//底面左下点
		vec3(0.4,-0.4,-0.333333),		//底面右下点
		
		vec3(0.0,0.0,1.0),                     //前方中心点
		vec3(0.0,-0.946,-0.333333),           //底面上方
		vec3(0.3,0.2,-0.333333),	//底面左下点
		vec3(-0.3,0.2,-0.333333),		//底面右下点
	];
	...
	gl.clearColor(0.0,0.0,0.9,0.1);   //视口背景色设置
...
function divideTetra(a,b,c,d,k){
	...
	if(k>0){
		//计算各边的中点
		mid[0] = mult(0.55,add(a,b));
		mid[1] = mult(0.55,add(a,c));
		mid[2] = mult(0.55,add(a,d));
		mid[5] = mult(0.25,add(b,c));
		mid[4] = mult(0.25,add(d,c));
		mid[3] = mult(0.25,add(b,d));
